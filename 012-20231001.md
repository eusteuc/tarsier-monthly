...
- 内核构建问题的修复方案和CI测试<details>: dwarves/pulls/10, kernel/pulls/1152</details>
- 贡献办公相关软件包<details>: libreffice-share-linker, libe-book</details>
- 2023 下半年系统构建工作已经启动
- 基础系统回合补丁有部分重复或者冲突，继续整理中
- 推进使能平头哥硬件，最快预计本月发行中可以整合
